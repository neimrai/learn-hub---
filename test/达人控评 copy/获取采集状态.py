...
def read_existing_data():
    ...
    url = f"https://open.feishu.cn/open-apis/sheets/v2/spreadsheets/VduWslSuehmnBrtUOsFcKN3lnWg/values/lXk5BV!A:F"
    params = {
...
for row in video_info:
  KOLID_list.append(row[6]),
  GMV_list.append(row[7]),
  RMB_list.append(row[8]),
